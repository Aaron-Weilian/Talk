package com.aiyun.module.order.bean;
...
public class OrderBean extends DBUtil {
	
	public CommonBean getOrderList() {
...
//		}
		...
		cb.setColNames(new String[] { "Rendering engine", "Browser","Platform(s)","Engine version" ,"CSS grade"});
		//cb.setVecData(vRet);
		return cb;
	}
	...
	public CommonBean getCond(CommonBean cbUser, CommonBean cbCond) {
		try {
			...
			String[][] arrYWType = com.aiyun.common.util.Function.bean2arr(cbYWType);
