$(document).ready(function() {
	...
	[
		"div#aiyun-searchbox input.aiyun-search-submit", 
		".aiyun-panel .aiyun-panel-header .aiyun-collapse-button span", 
	...
	var textTargets = 
	[
		".aiyun-panel .aiyun-panel-header span", 
		"div#aiyun-navigation ul li.active a", 
		"div#aiyun-navigation ul li.active span", 
		"div#aiyun-user-tools #aiyun-username", 
		"div#aiyun-navigation ul li span.aiyun-nav-tooltip", 
		"div#aiyun-user-tools #aiyun-user-info #aiyun-user-functions #aiyun-username", 
	...
	$("#test").bind("click", function(event) {
		...
		$("#aiyun-themer-css-dialog textarea").val(css);
		$("#aiyun-themer-css-dialog").dialog("open");
		event.preventDefault();
	  });
	
	$("#aiyun-themer-getcss").bind("click", function(event) {
		var css = 
			borderColorTargets.join(", \n") + "\n" + 
			"{\n"+
			"	border-color:" + baseColor + ";\n"+
	...
	var presetDd = $("#aiyun-theme-presets");
	...
	$("div#aiyun-themer #aiyun-themer-hide").bind("click", function(event) {
	...
	$("div#aiyun-themer #aiyun-themer-css-dialog").dialog({
		autoOpen: false, 
		title: "Theme CSS", 
		width: 500, 
		modal: true, 
	...
	//$("#aiyun-sidebar-stitch").click (function() {
//		$(document.body).on('click','div#aiyun-sidebar-stitch',function(){
//		alert("test");
//		var css = 
//			borderColorTargets.join(", \n") + "\n" + 
//			"{\n"+
...
//	$("div#aiyun-sidebar-stitch #aiyun-sidebar-bg #aiyun-sidebar-bg #aiyun-sidebar").bind("click", function(event) {
//		alert("test");
//		//$(this).toggleClass("opened").next().fadeToggle();
//	});
	
//	$("div#aiyun-sidebar-stitch #aiyun-sidebar-bg #aiyun-sidebar-bg #aiyun-sidebar").dialog({
//		autoOpen: false, 
//		title: "Theme CSS", 
//		width: 200, 
//		modal: true, 
...
//	});
	...
	{
		baseColor = "#" + hex;
		$("#aiyun-base-cp").css('backgroundColor', baseColor);
	...
	{
		textColor = "#" + hex;
		$("#aiyun-text-cp").css('backgroundColor', textColor);
	...
	function updateTextGlowColor(rgb, alpha)
	{
		...
		$("div#aiyun-themer #aiyun-textglow-op").slider("value", textGlowColor.a * 100);
		$("#aiyun-textglow-cp").css('backgroundColor', '#' + rgbToHex(textGlowColor.r, textGlowColor.g, textGlowColor.b));
